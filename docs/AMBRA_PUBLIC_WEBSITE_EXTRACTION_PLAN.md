...
- [ ] Move VMI public marketplace/marketing pages into `apps/public-web`
- [ ] Keep ERP auth/app routes on `app.ambra-system.com`
- [ ] Keep VMI auth/app routes on `vmi.ambra-system.com`
- [ ] Extract shared public UI/content/data helpers into reusable packages
- [ ] Add domain-aware redirects and canonical SEO metadata
- [ ] Add accessibility, performance, SEO, and E2E validation
- [ ] Deploy public website to `ambra-system.com` / `www.ambra-system.com`
...
- `src/app/page.tsx` -> `src/app/vmi/page.tsx`
- `src/app/vendors/page.tsx` -> `src/app/vmi/vendors/page.tsx`
- `src/app/vendors/[slug]/page.tsx` -> `src/app/vmi/vendors/[slug]/page.tsx`
- `src/app/products/page.tsx` -> `src/app/vmi/products/page.tsx`
- `src/app/products/[slug]/page.tsx` -> `src/app/vmi/products/[slug]/page.tsx`
- `src/app/flyers/[slug]/page.tsx` -> `src/app/vmi/flyers/[slug]/page.tsx`
