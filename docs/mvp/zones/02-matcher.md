...
- **2B. Authenticated / Persistent Matcher** — używa tego samego rdzennego silnika dopasowania, wymaga zalogowanego kontekstu Ambry, trwale zapisuje przetworzoną sesję/dane, i jest pomostem między samodzielnym narzędziem a operacyjnym systemem Ambra, przygotowującym dane dla dalszych przepływów (w tym Strefy 3).
