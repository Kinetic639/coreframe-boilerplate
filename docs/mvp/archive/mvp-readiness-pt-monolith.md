...
Stan wymagany to **cel przed prezentacją**, nie ocena obecnej implementacji — obecny stan (🔴/🟠/🟡) każdej strefy jest opisany wyłącznie w jej szczegółowej sekcji. Numery wskazują sekcje poniżej, nie dawne identyfikatory checklisty.
