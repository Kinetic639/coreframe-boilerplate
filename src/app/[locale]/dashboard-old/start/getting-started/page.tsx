...
async function GettingStartedContent() {
  ...
  const steps: Array<{
    ...
    },
    {
      ...
      icon: FileText,
      href: "/dashboard-old/warehouse/products",
    ...
    },
    {
      ...
      icon: Settings,
      href: "/dashboard-old/warehouse/settings",
    ...
    <div className="space-y-6">
      ...
      <Card className="border-muted">
        ...
        <CardContent className="flex gap-4">
          <Link href="/dashboard-old/support">
