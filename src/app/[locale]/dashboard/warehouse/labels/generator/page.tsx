...
const mockTemplates: LabelTemplate[] = [
  ...
  },
  {
    ...
    height_mm: 25,
    dpi: 300,
    template_config: { layout: "qr_with_text", margins: { top: 2, bottom: 2, left: 2, right: 2 } },
    qr_position: "left",
    qr_size_mm: 20,
  ...
  },
  {
    ...
    height_mm: 50,
    dpi: 300,
    template_config: { layout: "comprehensive", margins: { top: 5, bottom: 5, left: 5, right: 5 } },
...
export default function LabelGeneratorPage() {
  ...
  return (
    <div className="container mx-auto py-6">
      <LabelGenerator templates={mockTemplates} onGenerate={handleGenerate} isLoading={isLoading} />
    </div>
  );
}
