...
import { DraggableLocationTree } from "./draggable-location-tree";

interface DraggableLocationNodeProps {
...
export function DraggableLocationNode({
  location,
  onEdit,
  onAddChild,
  onDelete,
