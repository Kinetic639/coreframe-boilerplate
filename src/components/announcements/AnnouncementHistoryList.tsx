...
import { AnnouncementCard, AnnouncementPost } from "./AnnouncementCard";
...
import { getAnnouncementPosts } from "@/app/actions/announcements-actions";
...
export function AnnouncementHistoryList() {
  ...
  const [editingNews, setEditingNews] = useState<AnnouncementPost | null>(null);
  ...
  const loadNews = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const { data, error } = await getAnnouncementPosts();
  ...
  const handleEdit = (newsPost: AnnouncementPost) => {
