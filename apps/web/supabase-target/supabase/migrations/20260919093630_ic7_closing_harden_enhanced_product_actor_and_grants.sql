CREATE OR REPLACE FUNCTION public.inventory_create_enhanced_product(p_organization_id uuid, p_product jsonb, p_attributes jsonb DEFAULT '[]'::jsonb, p_variants jsonb DEFAULT '[]'::jsonb, p_tags jsonb DEFAULT '[]'::jsonb, p_custom_fields jsonb DEFAULT '[]'::jsonb, p_unit_conversions jsonb DEFAULT '[]'::jsonb, p_branch_id uuid DEFAULT NULL::uuid, p_actor_user_id uuid DEFAULT NULL::uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
...
REVOKE ALL ON FUNCTION public.inventory_create_enhanced_product(uuid, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, uuid, uuid) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.inventory_create_enhanced_product(uuid, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, uuid, uuid) FROM anon;
GRANT EXECUTE ON FUNCTION public.inventory_create_enhanced_product(uuid, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, uuid, uuid) TO authenticated, service_role;
