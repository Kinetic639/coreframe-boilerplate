-- Accepting a cross-branch transfer is a destination-branch decision, but it
-- must atomically consume source reservations and post source/destination stock.
