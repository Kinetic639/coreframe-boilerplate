            ...
            <CardContent className="space-y-4">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                  ...
                  <Link href="/dashboard-old/warehouse/settings/units">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                  ...
                  <Link href="/dashboard-old/warehouse/settings/variant-options">
                    <Button variant="outline" size="sm">
                      Manage
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                  ...
                  <Link href="/dashboard-old/warehouse/settings/custom-fields">
                    <Button variant="outline" size="sm">
                      Manage
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                  ...
                  <Link href="/dashboard-old/warehouse/settings/categories">
                    <Button variant="outline" size="sm">
                      Manage
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                  ...
                  <Link href="/dashboard-old/warehouse/settings/products-templates">
                    <Button variant="outline" size="sm">
                      Manage
                      <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
