...
import { ANALYTICS_AUDIT_READ } from "@/lib/constants/permissions";
...
export default async function AnalyticsAuditPage() {
  ...
  if (!checkPermission(context.user.permissionSnapshot, ANALYTICS_AUDIT_READ)) {
    return redirect({
      href: {
        pathname: "/dashboard/access-denied",
        query: { reason: "analytics_audit_read_required" },
      },
      locale,
    });
  }
