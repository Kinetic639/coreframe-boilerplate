...
export const EVENT_REGISTRY: Readonly<Record<string, EventRegistryEntry>> = {
  ...
  "workshop.repair_orders.created": {
    actionKey: "workshop.repair_orders.created",
    moduleSlug: "workshop",
    eventTier: "baseline",
    category: "STATE",
    intent: "CREATE",
    description: "A RepairOrder was created manually (no Matcher session involved)",
    metadataSchema: z.object({
      zlNumber: z.string().nullable(),
      identityStatus: z.string(),
    }),
    summaryTemplate: "Manually created RepairOrder",
    i18nKey: "events.workshop.repair_orders.created",
    iconKey: "plus",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
  ...
  "workshop.repair_orders.header_updated": {
    actionKey: "workshop.repair_orders.header_updated",
    moduleSlug: "workshop",
    eventTier: "baseline",
    category: "STATE",
    intent: "UPDATE",
    description: "A RepairOrder's editable header/business fields were changed",
    metadataSchema: z.object({
      fields: z.array(z.string()),
    }),
    summaryTemplate: "Updated RepairOrder header ({{fields}})",
    i18nKey: "events.workshop.repair_orders.header_updated",
    iconKey: "edit",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
  ...
  "workshop.repair_orders.advisor_assigned": {
    actionKey: "workshop.repair_orders.advisor_assigned",
    moduleSlug: "workshop",
    eventTier: "baseline",
    category: "STATE",
    intent: "ASSIGN",
    description: "A RepairOrder's advisor (owner) was assigned, reassigned, or cleared",
    metadataSchema: z.object({
      advisorContactId: z.string().uuid().nullable(),
    }),
    summaryTemplate: "Assigned RepairOrder advisor",
    i18nKey: "events.workshop.repair_orders.advisor_assigned",
    iconKey: "user-check",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
  ...
  "workshop.repair_orders.status_changed": {
    actionKey: "workshop.repair_orders.status_changed",
    moduleSlug: "workshop",
    eventTier: "baseline",
    category: "STATE",
    intent: "UPDATE",
    description: "A RepairOrder's lifecycle status changed (open/closed/archived)",
    metadataSchema: z.object({
      previousStatus: z.string(),
      newStatus: z.string(),
    }),
    summaryTemplate: "RepairOrder status changed ({{previousStatus}} -> {{newStatus}})",
    i18nKey: "events.workshop.repair_orders.status_changed",
    iconKey: "refresh-cw",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
  ...
  "workshop.repair_orders.container_created": {
    actionKey: "workshop.repair_orders.container_created",
    moduleSlug: "workshop",
    eventTier: "baseline",
    category: "STATE",
    intent: "CREATE",
    description: "A physical container was created for a RepairOrder (Phase 10C)",
    metadataSchema: z.object({
      containerId: z.string().uuid(),
      code: z.string(),
    }),
    summaryTemplate: "Created container {{code}} for a repair order",
    i18nKey: "events.workshop.repair_orders.container_created",
    iconKey: "box",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
  ...
  "workshop.repair_orders.stock_placed_in_container": {
    ...
    intent: "UPDATE",
    description:
      "Already-allocated stock for a RepairOrderLine was physically placed into a container (Phase 10C)",
    metadataSchema: z.object({
      containerId: z.string().uuid(),
      allocationLineId: z.string().uuid(),
      quantity: z.number().positive(),
    }),
    summaryTemplate: "Placed {{quantity}} into a container for a repair order line",
    i18nKey: "events.workshop.repair_orders.stock_placed_in_container",
    iconKey: "box",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
  ...
  "workshop.repair_orders.stock_removed_from_container": {
    actionKey: "workshop.repair_orders.stock_removed_from_container",
    moduleSlug: "workshop",
    eventTier: "baseline",
    category: "STATE",
    intent: "UPDATE",
    description: "Stock for a RepairOrderLine was physically removed from a container (Phase 10C)",
    metadataSchema: z.object({
      containerId: z.string().uuid(),
      linkId: z.string().uuid(),
      quantity: z.number().positive(),
    }),
    summaryTemplate: "Removed {{quantity}} from a container for a repair order line",
    i18nKey: "events.workshop.repair_orders.stock_removed_from_container",
    iconKey: "box",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
