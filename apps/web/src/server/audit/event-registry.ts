...
export const EVENT_REGISTRY: Readonly<Record<string, EventRegistryEntry>> = {
  ...
  "warehouse.inventory.branch_transfer.sent": {
    actionKey: "warehouse.inventory.branch_transfer.sent",
    moduleSlug: "warehouse",
    eventTier: "enhanced",
    category: "WAREHOUSE",
    intent: "UPDATE",
    i18nKey: "events.warehouse.inventory.branchTransfer.sent",
    description: "A cross-branch inventory transfer was physically shipped from the source branch",
    metadataSchema: z.object({
      transfer_id: z.string().uuid(),
    }),
    summaryTemplate: "Sent branch transfer",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
    visibilityClass: "org_activity",
  ...
  "warehouse.inventory.branch_transfer.cancelled": {
    actionKey: "warehouse.inventory.branch_transfer.cancelled",
    moduleSlug: "warehouse",
    eventTier: "enhanced",
    category: "WAREHOUSE",
    intent: "UPDATE",
    i18nKey: "events.warehouse.inventory.branchTransfer.cancelled",
    description:
      "A cross-branch inventory transfer was cancelled by the source branch before shipment",
    metadataSchema: z.object({
      transfer_id: z.string().uuid(),
      has_reason: z.boolean().optional(),
    }),
    summaryTemplate: "Cancelled branch transfer",
    scope: "branch",
    actorVisible: true,
    selfVisible: true,
    visibilityClass: "org_activity",
