-- =============================================
-- Fix location validation in create_stock_movement
-- Allow receipts without destination location (optional location)
-- =============================================

-- Recreate the function with updated validation
...
BEGIN
  ...
  -- For movement types that don't explicitly require either location,
  -- we allow movements without locations (e.g., receipts without immediate location assignment)
  -- This is valid for receipt type 101 where requires_destination_location = false
...
'Creates a stock movement with flexible location handling.
- Receipt movements (type 101) can optionally have destination_location_id = NULL
- Issue movements require source_location_id
- Transfer movements require both source and destination
- Validation is based on movement_types.requires_source_location and requires_destination_location flags';
