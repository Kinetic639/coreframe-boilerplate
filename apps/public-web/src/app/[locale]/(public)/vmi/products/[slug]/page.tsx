...
export async function generateMetadata({ params }: ProductDetailPageProps): Promise<Metadata> {
  ...
  const productResult = await PublicMarketplaceRepository.getProductBySlug(slug);

  if (!productResult.success) {
    return {
      title: "Produkt VMI | Ambra System",
  ...
  return {
    title: `${product.name} | Produkt VMI | Ambra System`,
    description: product.description,
    alternates: {
      canonical: `/vmi/products/${product.slug}`,
    },
    openGraph: {
      title: `${product.name} | Produkt VMI | Ambra System`,
      description: product.description,
      url: `/vmi/products/${product.slug}`,
        ...
        <div className="mt-6 grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Link
                href={`/vmi/products?category=${encodeURIComponent(product.category)}`}
