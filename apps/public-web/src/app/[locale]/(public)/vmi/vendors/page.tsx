...
export const metadata: Metadata = {
  title: "Dostawcy VMI | Ambra System",
  description: "Wyszukuj publicznych dostawców VMI po kategorii, mieście, gotowości VMI i profilu obsługi.",
  alternates: {
    canonical: "/vmi/vendors",
  },
  openGraph: {
    title: "Dostawcy VMI | Ambra System",
    description: "Wyszukuj publicznych dostawców VMI po kategorii, mieście, gotowości VMI i profilu obsługi.",
