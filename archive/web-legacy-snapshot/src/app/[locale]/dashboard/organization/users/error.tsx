...
export default function OrganizationUsersError({ error, reset }: ErrorProps) {
  useEffect(() => {
    ...
    <div className="flex h-full w-full items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>An unexpected error occurred in the users section.</CardDescription>
        </CardHeader>
